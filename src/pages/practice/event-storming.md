...
whatIs: >-
  Event Storming is a rapid, interactive approach to business process discovery and design that yields high-quality models. Introduced by Alberto Brandolini in 2013, it’s an engaging and effective way to map out complex business processes collaboratively.
  ...
  * A **visual representation** (physical or digital) of the process that can be refined and expanded over time.
  
  For a Customer Success leaders, Event Storming offers a powerful way to align Sales, Onboarding, Product, and Customer Success teams by fostering shared understanding and focusing on outcomes that matter to customers.
